...
class StreamDiffusion:
    def __init__(
        self,
        pipe: StableDiffusionPipeline,                                                  # Using Stable Diffusion pipeline
        t_index_list: List[int],
        torch_dtype: torch.dtype = torch.float16,
        width: int = 512,
        height: int = 512,
        do_add_noise: bool = True,
        use_denoising_batch: bool = True,                                               # Denoising Batch = True
        ...
        self.latent_height = int(height // pipe.vae_scale_factor)                       # Latent space size
        self.latent_width = int(width // pipe.vae_scale_factor)                         # Latent space size

        self.frame_bff_size = frame_buffer_size
        self.denoising_steps_num = len(t_index_list)                                    # Init denoise Steps

        self.cfg_type = cfg_type                                                        # Set classify-free guidance
